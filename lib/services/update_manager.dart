...
import 'package:del_player/widgets/auto_format_text.dart';
...
const String downloadFilename = 'DelPlayer.apk';

Future<void> checkAppUpdates() async {
  if (checkUrl.isEmpty || releasesUrl.isEmpty) return;
  try {
