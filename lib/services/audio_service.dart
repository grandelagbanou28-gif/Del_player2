...
import 'package:del_player/models/position_data.dart';
...
import 'package:del_player/utilities/map_utils.dart';
import 'package:del_player/utilities/mediaitem.dart';
import 'package:del_player/utilities/queue_entry_utils.dart';
import 'package:rxdart/rxdart.dart';

class DelPlayerAudioHandler extends BaseAudioHandler {
  DelPlayerAudioHandler() {
  ...
  MediaItem? _mediaItemForResumption(Map song) {
    ...
    return mapToMediaItem(normalisedSong).copyWith(
      ...
      displaySubtitle: artist.isEmpty ? 'delplayer' : artist,
    );
  }
