...
import 'package:del_player/services/audio_service.dart';
import 'package:del_player/services/data_manager.dart';
import 'package:del_player/services/io_service.dart';
import 'package:del_player/services/logger_service.dart';
...
class DelPlayer extends StatefulWidget {
  const DelPlayer({super.key});
  ...
  static Future<void> updateAppState(
    ...
    context.findAncestorStateOfType<_DelPlayerState>()!.changeSettings(
  ...
  @override
  _DelPlayerState createState() => _DelPlayerState();
}

class _DelPlayerState extends State<DelPlayer> {
  void changeSettings({
    ThemeMode? newThemeMode,
    Locale? newLocale,
    Color? newAccentColor,
...
Future<void> initialisation() async {
  try {
    ...
    audioHandler = await AudioService.init(
      builder: DelPlayerAudioHandler.new,
...
void handleIncomingLink(Uri? uri) async {
  if (uri != null && uri.scheme == 'delplayer' && uri.host == 'playlist') {
    try {
